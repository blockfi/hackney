...
request(Method, #hackney_url{}=URL0, Headers0, Body, Options0) ->
  ...
  EncodedSpanCtx = oc_propagation_http_tracecontext:encode(NewSpanCtx),
  Headers1 = hackney_headers_new:new([{oc_tag_ctx_header:field_name(), EncodedSpanCtx} | Headers0]),
